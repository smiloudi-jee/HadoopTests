...
import com.minicluster.modules.hbase.HBaseBootstrap;
import com.minicluster.modules.mapreduce.MapReduceBootstrap;
import com.minicluster.modules.hbase.HBaseServiceHandle;
import com.minicluster.modules.pig.PigBootstrap;
import com.minicluster.modules.yarn.YarnBootstrap;
import com.minicluster.modules.hive.HiveBootstrap;
import com.minicluster.modules.hive.HiveServiceHandle;
import com.minicluster.modules.mapreduce.MapReduceServiceHandle;
import com.minicluster.modules.pig.PigServiceHandle;
import com.minicluster.modules.rest.RestBootstrap;
import com.minicluster.modules.rest.RestServiceHandle;
import com.minicluster.modules.spark.SparkBootstrap;
import com.minicluster.modules.spark.SparkServiceHandle;
import com.minicluster.modules.yarn.YarnServiceHandle;
import com.minicluster.util.PrinterTools;
    ...
    public static ClusterRuntime start(ClusterRuntimeConfig cfg) throws Exception {
        ...
        if (cfg.isYarnEnabled()) {
            yarnHandle = Optional.of(
                    YarnBootstrap.startYarn(hadoopConf)
            );
        }
        ...
        if (cfg.isMapReduceEnabled()) {
            mapReduceHandle = Optional.of(
                    MapReduceBootstrap.startLocalMapReduce(hadoopConf, hdfsUri)
            );
        }
        ...
        if (cfg.isHBaseEnabled()) {
            assertNotNull(HBaseBootstrap.startHBase(),
                    "HB aseHandle should not be null");
            hbaseHandle = Optional.of(
                    HBaseBootstrap.startHBase()
            );
        }
        ...
        if (cfg.isPigEnabled()) {
            pigHandle = Optional.of(
                    PigBootstrap.startPig(hadoopConf, hdfsUri)
            );
        }
